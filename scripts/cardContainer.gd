...
## This originates from my shiba game-launcher, but has been edited to work with the X instead 
...
@export var SelectedYOffset : float = 30.0: ## The horizontal offset applied to the focused node.
		set(value): SelectedYOffset = value; queue_sort()
